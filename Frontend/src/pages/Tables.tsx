...
export default function Tables() {
  ...
  const handleStatusChange = (tableId: string, newStatus: "Available" | "Booked" | "Occupied") => {
    updateTable(tableId, { 
      status: newStatus,
      customer: newStatus === 'Available' ? undefined : tables.find(t => t.id === tableId)?.customer
    });
  };
  ...
  return (
    <div className="p-4 max-w-7xl mx-auto">
      ...
      {/* Add Table and Book Table Buttons */}
              ...
              <div className="flex gap-2 mt-4">
                <Button
                  ...
                  onClick={() => handleStatusChange(
                    table.id, 
                    table.status === 'Available' ? 'Booked' : 'Available'
                  )}
                >
                  {table.status === 'Available' ? 'Book' : 'Free'}
                </Button>
                <Button
                  variant="outline"
                  size="sm"
